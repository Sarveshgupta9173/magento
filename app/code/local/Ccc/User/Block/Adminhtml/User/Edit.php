...
class Ccc_User_Block_Adminhtml_User_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        if ($this->_isAllowedAction('delete')) {
            $this->_updateButton('delete', 'label', Mage::helper('user')->__('Delete users'));
        } else {
    ...
    {
        if (Mage::registry('user_edit')->getId()) {
            return Mage::helper('user')->__("Edit user '%s'", $this->escapeHtml(Mage::registry('user_edit')->getTitle()));
        }
        else {
