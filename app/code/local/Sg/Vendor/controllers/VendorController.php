...
class Sg_Adminhtml_VendorController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
         ...
         * Add breadcrumb item
         */
        $this->_addBreadcrumb(Mage::helper('adminhtml')->__('Vendors'), Mage::helper('adminhtml')->__('Vendors'));
        $this->_addBreadcrumb(Mage::helper('adminhtml')->__('Manage Vendors'), Mage::helper('adminhtml')->__('Manage Vendors'));
    ...
    public function editAction()
    {
        ...
        $this->_title($customer->getId() ? $customer->getName() : $this->__('New Vendor'));
